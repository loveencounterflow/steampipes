(function() {
  ...
  this._get_asyncfunction = function() {
    return [
      'asyncfunction',
      (async function() {
        await 42;
  ...
  this._get_all_probes_and_matchers = function() {
    return [...this._get_standard_iterables(), this._get_custom_iterable_2(), this._get_generatorfunction(), this._get_asyncgenerator(), this._get_asyncgeneratorfunction(), this._get_custom_iterable_1(), this._get_function(), this._get_asyncfunction()];
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["normalize_source"] = async function(T, done) {
    SP._normalize_source = function(probe) {
      var async_iterator, iterate, iterator, mode, original_probe_type, probe_type, ref;
      //.......................................................................................................
      /* STEP 1 */
      mode = 'sync';
      original_probe_type = type_of(probe);
      //.......................................................................................................
      if ((ref = (probe_type = type_of(probe))) === 'generatorfunction' || ref === 'asyncgeneratorfunction') {
        probe = probe();
        probe_type = type_of(probe);
      }
      //.......................................................................................................
      ...
      if (iterator == null) {
        ...
        debug('^33321^', probe); // ( iterator_type = type_of iterator ) is 'function'
      }
      //.......................................................................................................
      if (!((mode === 'sync' && (iterator != null)) || (mode === 'async' && (async_iterator != null)))) {
      ...
      if (mode === 'sync') {
        iterate = function() {
          return iterator.apply(probe);
        };
      } else {
        iterate = function() {
          return async_iterator.apply(probe);
        };
      }
      //.......................................................................................................
      return {mode, iterate};
    ...
    return (await (async() => {
      ...
      for (i = 0, len = probes_and_matchers.length; i < len; i++) {
        ...
        await T.perform(probe, matcher, error, function() {
          return new Promise(async function(resolve, reject) {
            var d, iterate, mode, ref, ref1, result;
            result = [];
            whisper('-------------------');
            info(name);
  ...
  this["iterate"] = async function(T, done) {
    var check_count, d, error, hit_count, i, len, matcher, name, name_txt, probes_and_matchers, ref, result, source, type;
    probes_and_matchers = this._get_all_probes_and_matchers();
    check_count = 0;
    hit_count = 0;
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      try {
        if (type === 'asyncgenerator') {
          info(name_txt, CND.green('sync '), CND.grey(type), CND.blue(result = (await (async function() {
            var results;
            results = [];
          ...
          info(name_txt, CND.red('async'), CND.grey(type), CND.blue(result = (function() {
            var results;
            results = [];
            for (d of source) {
              results.push(d);

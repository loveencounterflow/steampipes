(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["_  composability 1"] = async function(T, done) {
    var error, matcher, probe;
    [probe, matcher, error] = [["what", "a", "lot", "of", "little", "bottles"], ["what", "a", "lot", "of", "little", "bottles"], null];
    await T.perform(probe, matcher, error, function() {
      return new Promise(function(resolve, reject) {
        ...
        T.eq(duct_A.transforms.length, length_of_B);
        T.eq(duct_A.type, 'circuit');
        return null;
      });
    });
    //.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["_  composability 2"] = async function(T, done) {
    var error, matcher, probe;
    [probe, matcher, error] = [["what", "a", "lot", "of", "little", "bottles"], ["what", "a", "lot", "of", "little", "bottles"], null];
    await T.perform(probe, matcher, error, function() {
      return new Promise(function(resolve, reject) {
...
// test @[ "composability 1"                 ]
// test @[ "composability 2"                 ]

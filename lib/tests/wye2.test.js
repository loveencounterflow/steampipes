(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["wye construction (method)"] = function(T, done) {
    var provide_new_wye;
    //.........................................................................................................
    provide_new_wye = function() {
      var _original_pull/* TAINT overwrites original attribute */, last;
      last = Symbol('last');
      this.marks = {
        isa_wye: Symbol('isa_wye')
      };
      _original_pull = this.pull;
      //-----------------------------------------------------------------------------------------------------------
      ...
      //-----------------------------------------------------------------------------------------------------------
      return this.pull = function(...transforms) {
        var R;
        R = _original_pull.call(this, ...transforms);
        debug('^33342^', R);
        return R;
      };
    };
  ...
  if (module.parent == null) {
    ...
    test(this["wye construction (method)"]);
  }

(function() {
  'use strict';
  var $watch, CND, assign, badge, debug, declare, echo, first_of, help, info, isa, jr, last_of, remit_defaults, rpr, size_of, type_of, types, urge, validate, warn, whisper;
  ...
  this._pull = function(...transforms) {
    var R, _, description, exhaust_pipeline, has_sink, has_source, last, local_sink, local_source, mem_source, mem_sources, on_end, original_source, send;
  ...
  this.pull = function(...transforms) {
    ...
    //.........................................................................................................
    S.mem_source.push(this.symbols.last);
    S.exhaust_pipeline();
    if (S.on_end != null) {
      S.on_end();
    }
  ...
  this.new_push_source = function() {
    ...
    R = (function*() {
      ...
      while (true) {
        if (buffer.length > 0) {
          results.push((yield buffer.shift()));
        } else {
          results.push(void 0);
        }
      }
    ...
    R.end = () => {
      return R.send(this.symbols.end);
    };
    R = {[ref = this.symbols.push_source_mark]: ref};
    return R;
  };

  //-----------------------------------------------------------------------------------------------------------
  this.push = function(...transforms) {
    var S, end, send;
    S = this._pull(...transforms);
    send = (d) => {
      S.mem_source.push(d);

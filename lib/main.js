(function() {
  ...
  this._pull = function(...transforms) {
    var R, _, blurb, exhaust_pipeline, has_sink, has_source, last, local_sink, local_source, mem_source, mem_sources, on_end, original_source, send;
    blurb = this._classify_pipeline(transforms);
    has_sink = false;
    has_source = false;
    on_end = null;
    original_source = null;
    if (blurb.last.type === 'source') {
      throw new Error("µ77764 source as last transform not yet supported");
    }
    if (blurb.first.type === 'sink') {
      throw new Error("µ77765 sink as first transform not yet supported");
    }
    //.........................................................................................................
    if (blurb.first.type === 'source') {
      original_source = transforms.shift();
      if (blurb.first.must_call) {
        original_source = original_source();
      }
      has_source = true;
    }
    //.........................................................................................................
    if (blurb.last.type === 'sink') {
      has_sink = true;
  ...
  this.pull = function(...transforms) {
    var blurb, d, ref;
    blurb = this._pull(...transforms);
    if (blurb.original_source[this.marks.push_source] != null) {
      return this._push(blurb);
    }
    ref = blurb.original_source;
    //.........................................................................................................
    for (d of ref) {
      if (blurb.has_ended) {
        break;
    ...
    //.........................................................................................................
    blurb.mem_source.push(this.signals.last);
    blurb.exhaust_pipeline();
    if (blurb.on_end != null) {
      blurb.on_end();
    }
    return null;
  };
  ...
  this.new_push_source = function() {
    ...
    send = (d) => {
      ...
      R.blurb.mem_source.push(this.signals.last);
      R.blurb.exhaust_pipeline();
      if (R.blurb.on_end != null) {
        R.blurb.on_end();
      }
      return R.blurb = null;
    };

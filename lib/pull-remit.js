(function() {
  ...
  this._pull = function(...transforms) {
    var _, duct, exhaust_pipeline, has_local_sink, last, local_sink, local_source, mem_source, mem_sources, original_source, ref, send, source, tf_idxs;
    ...
    duct.mem_sources = mem_sources = [
      ...
      results;
        results = [];
        for (_ = i = 0, ref = transforms.length - 2; (0 <= ref ? i < ref : i > ref); _ = 0 <= ref ? ++i : --i) {
          results.push([]);
        }
        return results;
      })())
    ...
    tf_idxs = (function() {
      var results = [];
      for (var i = 0, ref = mem_sources.length - 1; 0 <= ref ? i <= ref : i >= ref; 0 <= ref ? i++ : i--){ results.push(i); }
      return results;
    }).apply(this);
    //.........................................................................................................
    send = (d) => {

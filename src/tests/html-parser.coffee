...
probes_and_matchers = [
  ...
  ["<title>MKTS</title>",[{"$key":"<title"},{"text":"MKTS","$key":"^text"},{"$key":">title"}],null]
  ["<p foo bar=42>omg</p>",[{"data":{"foo":true,"bar":"42"},"$key":"<p"},{"text":"omg","$key":"^text"},{"$key":">p"}],null]
  ...
  ["<!DOCTYPE html><html lang=en><head><title>x</title></head><p data-x='<'>helo</p></html>",[{"data":{"html":true},"$key":"<!DOCTYPE"},{"data":{"lang":"en"},"$key":"<html"},{"$key":"<head"},{"$key":"<title"},{"text":"x","$key":"^text"},{"$key":">title"},{"$key":">head"},{"data":{"data-x":"<"},"$key":"<p"},{"text":"helo","$key":"^text"},{"$key":">p"},{"$key":">html"}],null]
  ["<p foo bar=42><em>Yaffir stood high</em></p>",[{"data":{"foo":true,"bar":"42"},"$key":"<p"},{"$key":"<em"},{"text":"Yaffir stood high","$key":"^text"},{"$key":">em"},{"$key":">p"}],null]
  ["<p foo bar=42><em><xxxxxxxxxxxxxxxxxxx>Yaffir stood high</p>",[{"data":{"foo":true,"bar":"42"},"$key":"<p"},{"$key":"<em"},{"$key":"<xxxxxxxxxxxxxxxxxxx"},{"text":"Yaffir stood high","$key":"^text"},{"$key":">p"}],null]
  ["<p föö bär=42><em>Yaffir stood high</p>",[{"data":{"föö":true,"bär":"42"},"$key":"<p"},{"$key":"<em"},{"text":"Yaffir stood high","$key":"^text"},{"$key":">p"}],null]
  ...
  ["<p foo bar=<>yeah</p>",[{"data":{"foo":true,"bar":"<"},"$key":"<p"},{"text":"yeah","$key":"^text"},{"$key":">p"}],null]
  ["<p foo bar='<'>yeah</p>",[{"data":{"foo":true,"bar":"<"},"$key":"<p"},{"text":"yeah","$key":"^text"},{"$key":">p"}],null]
  ["<p foo bar='&lt;'>yeah</p>",[{"data":{"foo":true,"bar":"&lt;"},"$key":"<p"},{"text":"yeah","$key":"^text"},{"$key":">p"}],null]
  ["<<<<<",[{"text":"<<<<","$key":"^text"}],null]
  ["something",[{"text":"something","$key":"^text"}],null]
  ["else",[{"text":"else","$key":"^text"}],null]
  ["<p>dangling",[{"$key":"<p"},{"text":"dangling","$key":"^text"}],null]
